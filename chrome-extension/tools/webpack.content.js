// tools/webpack.content.js
require('dotenv').config(); // Load local .env into process.env
const webpack = require('webpack');
const { merge } = require('webpack-merge');

/**
 * A custom webpack configuration file for the Content Script build.
 * Similar to webpack.main.js, merges default config with environment definitions.
 */
